						...
						<ul class="navbar-nav header-right">
							...
							<li class="nav-item dropdown  header-profile">
								<a class="nav-link" href="javascript:void(0);" role="button" data-bs-toggle="dropdown">
									<img src="../uploads/WhatsApp Image 2024-06-15 at 09.30.12_650fc9d4.jpg" width="56"
										alt="" />
								</a>
								<div class="dropdown-menu dropdown-menu-end">
			...
			<div class="deznav-scroll">
				<ul class="metismenu" id="menu">
					...
					<li class="mm-active"><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="true">
						...
						<ul aria-expanded="false">
						    <li class="mm-active"><a href="appoinment_form.php">Appoinment Form</a></li>
					...
					<li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
						...
						<ul aria-expanded="false">
							<li><a href="Appoinments_list.php">Appoinments</a></li>
