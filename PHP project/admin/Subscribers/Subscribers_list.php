                ...
                <ul class="metismenu" id="menu">
                    ...
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
							...
							<li><a href="subscribe_form.php">Subscribe form</a></li>
                        </ul>
                    </li>
                    <li class="mm-active"><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="true">
                        ...
                        <ul aria-expanded="true">
                            ...
                            <li class="mm-active"><a href="../Messages/Messages_list.php">Messages</a></li>
        ...
        <div class="content-body">
            ...
            <div class="container-fluid">
                <div class="mb-sm-4 d-flex flex-wrap align-items-center text-head">
                    <h2 class="mb-3 me-auto">Subscribers</h2>
                </div>
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Total Subscribers are <?php
                                            include "../connect.php";
                                    ...
                                    <table id="example3" class="display" style="min-width: 845px">
                                        ...
                                        <tbody>
                                            ...
                                            if ($total != 0) {
                                                ...
                                                echo "<tr>
														<td colspan='9' class='text-center text-warning fs-3'><span class='fw-bold rounded-3 light'>No Record is present!</span></td>
													</tr>";
                                            }
                                            ?>
                                        </tbody>
