        ...
        <div class="content-body">
            ...
            <div class="container-fluid">
                <div class="mb-sm-4 d-flex flex-wrap align-items-center text-head">
                    <h2 class="mb-3 me-auto">Edit Home</h2>
                </div>
                <div class="row">
                    <div class="col-12">
                        <div class="card" style="">
                            ...
                            <div class="card-body">
                                <div class="form-validation">
                                    ...
                                    $sql = "SELECT * FROM home WHERE id = 1"; // Use single quotes for values
                                        ...
                                        <div class="row">
                                            <div class="col-12 col-md-6 mb-3">
                                                ...
                                                <textarea type="text" name="heading" class="form-control"
                                                    id="validationCustom01" required><?php
                                                    echo $row['heading'];
                                                    ?></textarea>
                                            ...
                                            <div class="col-12 col-md-6 mb-3">
                                                ...
                                                <textarea type="text" name="sub_heading" class="form-control"
                                                    id="validationCustom02" required><?php
                                            ...
                                            <div class="col-12 col-md-6 mb-3">
                                                <label class="col-form-label">New Background :-
                                                </label>
                                                <div class="input-group">
                                                    <div class="form-file rounded-4 ps-2">
                                                        <input name="bg_image" type="file"
                                                            class="form-file-input py-3 rounded-4 form-control p-2">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-12 col-md-6 mb-3">
                                                <label class="col-form-label" for="validationCustom03">Apppoinment
                                                    button text <span class="text-danger">*</span> :-
                                                </label>
                                                <input type="text" name="btn_text" class="form-control"
                                                    id="validationCustom03" placeholder="Enter Text here for button.."
                                                    value="<?php
                                                    echo $row['btn_text'];
                                                    ?>" required>
                                                <div class="invalid-feedback">
                                            ...
                                            <div class="col-12 col-md-6 mb-3">
                                                <label class="col-form-label">Card icon :-</label>
                                                <div class="d-flex w-50 border p-2">
                                                    <img src="../uploads/<?php
                                                    echo $row['box1_icon'];
                                                    ?>" alt="" class="w-100">
                                            ...
                                            <div class="col-12 col-md-6 mb-3">
                                                <label class="col-form-label">New Card icon :-
                                                </label>
                                                <div class="input-group">
                                                    <div class="form-file rounded-4 ps-2">
                                            ...
                                            <div class="col-12 col-md-6 mb-3">
                                                ...
                                                <textarea type="text" name="box1_heding" class="form-control"
                                                    id="validationCustom05" required><?php
                                                    echo $row['box1_heding'];
                                                    ?></textarea>
                                                <div class="invalid-feedback">
                                                    Please fill this.
                                                </div>
                                            ...
                                            <div class="col-12 col-md-6 mb-3">
                                                ...
                                                <textarea type="text" name="box1_subheding" class="form-control"
                                                    id="validationCustom06" required><?php
                                                    echo $row['box1_subheding'];
                                                    ?></textarea>
                                                <div class="invalid-feedback">
                                                    Please fill this.
                                                </div>
                                            ...
                                            <div class="col-12 col-md-6 mb-3">
                                                ...
                                                <textarea type="text" name="box2_heding" class="form-control"
                                                    id="validationCustom07" required><?php
                                                    echo $row['box2_heding'];
                                                    ?></textarea>
                                                <div class="invalid-feedback">
                                                    Please fill this.
                                                </div>
                                            ...
                                            <div class="col-12 col-md-6 mb-3">
                                                ...
                                                <textarea type="text" name="box2_subheding" class="form-control"
                                                    id="validationCustom08" required><?php
                                                    echo $row['box2_subheding'];
                                                    ?></textarea>
                                                <div class="invalid-feedback">
                                                    Please fill this.
                                                </div>
                                            ...
                                            <div class="col-12 col-md-6 mb-3">
                                                ...
                                                <textarea type="text" name="box3_heding" class="form-control"
                                                    id="validationCustom09" required><?php
                                                    echo $row['box3_heding'];
                                                    ?></textarea>
                                                <div class="invalid-feedback">
                                                    Please fill this.
                                                </div>
                                            ...
                                            <div class="col-12 col-md-6 mb-3">
                                                <label class="col-lg-4 col-form-label" for="validationCustom010">
                                                    About this :-
                                                </label>
                                                <textarea type="text" name="box3_subheding" class="form-control"
                                                    id="validationCustom010" required><?php
                                                    echo $row['box3_subheding'];
                                                    ?></textarea>
                                                <div class="invalid-feedback">
                                                    Please fill this.
                                                </div>
...
function handleFileUpload($fileInputName, &$fileName, $uploadDir)
{
    if (isset($_FILES[$fileInputName]) && $_FILES[$fileInputName]['error'] === UPLOAD_ERR_OK) {
        ...
        $duplicatecheck = file_exists($destination);
        if ($duplicatecheck) {
            echo "<script>
...
if (isset($_POST['submit'])) {
    ...
    $fileName = $row['bg_image'];
    $fileName1 = $row['box1_icon'];
    $fileName2 = $row['box2_icon'];
    $fileName3 = $row['box3_icon'];

    // Handle file uploads
    $fileName = handleFileUpload('bg_image', $fileName, $uploadDir);
    $fileName1 = handleFileUpload('box1_icon', $fileName1, $uploadDir);
    $fileName2 = handleFileUpload('box2_icon', $fileName2, $uploadDir);
    $fileName3 = handleFileUpload('box3_icon', $fileName3, $uploadDir);
    ...
    $box1_heding = $conn->real_escape_string($_POST['box1_heding']);
    $box2_heding = $conn->real_escape_string($_POST['box2_heding']);
    $box3_heding = $conn->real_escape_string($_POST['box3_heding']);
    $box1_subheding = $conn->real_escape_string($_POST['box1_subheding']);
    $box2_subheding = $conn->real_escape_string($_POST['box2_subheding']);
    $box3_subheding = $conn->real_escape_string($_POST['box3_subheding']);

    // Prepare the SQL statement with placeholders
    $stmt = $conn->prepare("UPDATE `home` SET `heading`=?, `sub_heading`=?, `btn_text`=?, `btn_color`=?, `bg_image`=?, `box1_icon`=?, `box2_icon`=?, `box3_icon`=?, `box1_heding`=?, `box2_heding`=?, `box3_heding`=?, `box1_subheding`=?, `box2_subheding`=?, `box3_subheding`=? WHERE `id`='1'");
    if ($stmt === false) {
        die("Failed to prepare the statement: " . htmlspecialchars($conn->error));
    }

    // Bind parameters
    $stmt->bind_param('ssssssssssssss', $heading, $sub_heading, $btn_text, $btn_color, $fileName, $fileName1, $fileName2, $fileName3, $box1_heding, $box2_heding, $box3_heding, $box1_subheding, $box2_subheding, $box3_subheding);

    // Execute the statement
    if ($stmt->execute()) {
        if ($heading == $row['heading'] || $sub_heading == $row['sub_heading'] || $btn_text == $row['btn_text'] || $btn_color == $row['btn_color'] || $fileName == $row['fileName'] || $fileName1 == $row['fileName1'] || $fileName2 == $row['fileName2'] || $fileName3 == $row['fileName3'] || $box1_heding == $row['box1_heding'] || $box2_heding == $row['box2_heding'] || $box3_heding == $row['box3_heding'] || $box1_subheding == $row['box1_subheding'] || $box2_subheding == $row['box2_subheding'] || $box3_subheding == $row['box3_subheding']) {
            echo "<script>
            alert('Items are updated successfuly.');
            window.location.href = 'http://localhost/PHP%20project/admin/Pages/Home(edit).php';
          </script>";
        } else {
            echo "<script>
