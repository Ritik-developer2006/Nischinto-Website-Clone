                ...
                <ul class="metismenu" id="menu">
                    ...
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            ...
                            <li><a href="Messages_list.php">Messages</a></li>
        ...
        <div class="content-body">
            ...
            <div class="container-fluid">
                <div class="mb-sm-4 d-flex flex-wrap align-items-center text-head">
                    <h2 class="mb-3 me-auto">Edit Footer</h2>
                </div>
                <div class="row">
                    <div class="col-12">
                        <div class="card" style="">
                            <div class="card-header">
                                <h2>Footer's Items</h2>
                            </div>
                            <div class="card-body">
                                <div class="form-validation">
                                    ...
                                    <form class="needs-validation" novalidate method="post"
                                        ...
                                        <div class="col-12 mb-3">
                                                ...
                                                <textarea type="text" name="map" class="form-control"
                                                    id="validationCustom06" required><?php
                                                    echo $row['map'];
                                                    ?></textarea>
                                                <div class="text-warning mt-2 fw-bold"><small>*Please type only source address of map from iframe.</small></div>
                                                <div class="invalid-feedback">
                                                    Please fill this.
                                                </div>
                                            </div>
                                            <div class="col-6 col-md-6 mb-3">
                                                <label class="col-form-label" for="validationCustom02">Logo
                                                    :-</label>
                                            ...
                                            <div class="col-6 col-md-6 mb-3">
                                                <label class="col-form-label" for="validationCustom02">Set New Logo :-
                                                </label>
                                            ...
                                            <div class="col-6 mb-3">
                                                <label class="col-form-label" for="validationCustom05">Footer Title Color<span
                                                        class="text-danger">*</span> :-
                                                </label>
                                                <select class="form-select py-3 border-1 rounded-4" name="color"
                                                    ...
                                                    <option value="text-light">text-light</option>
                                            ...
                                            <div class="col-12 mb-3">
                                                <label class="col-form-label"
                                                    for="validationCustom04">Title<span
                                                        class="text-danger">*</span> :-
                                                </label>
                                            ...
                                            <div class="col-6 col-md-3 mb-3">
                                                <label class="col-form-label"
                                                    for="validationCustom04">Item 1<span
                                                        class="text-danger">*</span> :-
                                                </label>
                                                <input type="text" name="ul_1" class="form-control"
                                                    id="validationCustom04" placeholder="Enter Text here for button.."
                                                    value="<?php
                                                    echo $row['ul_1'];
                                                    ?>" required>
                                            ...
                                            <div class="col-6 col-md-3 mb-3">
                                                <label class="col-form-label"
                                                    for="validationCustom04">Item 2<span
                                                        class="text-danger">*</span> :-
                                                </label>
                                                <input type="text" name="ul_2" class="form-control"
                                                    id="validationCustom04" placeholder="Enter Text here for button.."
                                                    value="<?php
                                                    echo $row['ul_2'];
                                                    ?>" required>
                                            ...
                                            <div class="col-6 col-md-3 mb-3">
                                                <label class="col-form-label"
                                                    for="validationCustom04">Item 3<span
                                                        class="text-danger">*</span> :-
                                                </label>
                                                <input type="text" name="ul_3" class="form-control"
                                                    id="validationCustom04" placeholder="Enter Text here for button.."
                                                    value="<?php
                                                    echo $row['ul_3'];
                                                    ?>" required>
                                            ...
                                            <div class="col-6 col-md-3 mb-3">
                                                <label class="col-form-label"
                                                    for="validationCustom04">Item 4<span
                                                        class="text-danger">*</span> :-
                                                </label>
                                                <input type="text" name="ul_4" class="form-control"
                                                    id="validationCustom04" placeholder="Enter Text here for button.."
                                                    value="<?php
                                                    echo $row['ul_4'];
                                                    ?>" required>
                                            ...
                                            <div class="col-6 col-md-3 mb-3">
                                                ...
                                                <input type="text" name="d_1" class="form-control"
                                                    id="validationCustom04" placeholder="Enter Text here for button.."
                                                    value="<?php
                                                    echo $row['d_1'];
                                                    ?>" required>
                                            ...
                                            <div class="col-6 col-md-3 mb-3">
                                                ...
                                                <input type="text" name="d_2" class="form-control"
                                                    id="validationCustom04" placeholder="Enter Text here for button.."
                                                    value="<?php
                                                    echo $row['d_2'];
                                                    ?>" required>
                                            ...
                                            <div class="col-6 col-md-3 mb-3">
                                                ...
                                                <input type="text" name="d_3" class="form-control"
                                                    id="validationCustom04" placeholder="Enter Text here for button.."
                                                    value="<?php
                                                    echo $row['d_3'];
                                                    ?>" required>
                                            ...
                                            <div class="col-6 col-md-3 mb-3">
                                                ...
                                                <input type="text" name="d_4" class="form-control"
                                                    id="validationCustom04" placeholder="Enter Text here for button.."
                                                    value="<?php
                                                    echo $row['d_4'];
                                                    ?>" required>
                                            ...
                                            <div class="col-6 col-md-3 mb-3">
                                                <label class="col-form-label"
                                                    for="validationCustom04">Address<span
                                                        class="text-danger">*</span> :-
                                                </label>
                                            ...
                                            <div class="col-6 col-md-3 mb-3">
                                                <label class="col-form-label"
                                                    for="validationCustom04">Contact number<span
                                                        class="text-danger">*</span> :-
                                                </label>
                                                <input type="text" name="number_1" class="form-control"
                                                    id="validationCustom04" placeholder="Enter Text here for button.."
                                                    value="<?php
                                                    echo $row['number_1'];
                                                    ?>" required>
                                            ...
                                            <div class="col-6 col-md-3 mb-3">
                                                <label class="col-form-label"
                                                    for="validationCustom04">Alternate number<span
                                                        class="text-danger">*</span> :-
                                                </label>
                                                <input type="text" name="number_2" class="form-control"
                                                    id="validationCustom04" placeholder="Enter Text here for button.."
                                                    value="<?php
                                                    echo $row['number_2'];
                                                    ?>" required>
                                            ...
                                            <div class="col-12 smb-3">
                                                <label class="col-form-label text-warning fw-bold"
                                                    for="validationCustom04">
                                                    <small>
                                                        Tip :- For Changing icon of app links go to bootstrap and copy svg code and paste it in source code.
                                                    </small>
                                                </label>
                                            </div>
...
if (isset($_POST['submit'])) {
    ...
    $fileName = isset($row['logo']) ? $row['logo'] : '';
    ...
    $number_1 = $conn->real_escape_string($_POST['number_1']);
    $number_2 = $conn->real_escape_string($_POST['number_2']);
    $about = $conn->real_escape_string($_POST['about']);
    $ul_1 = $conn->real_escape_string($_POST['ul_1']);
    $ul_2 = $conn->real_escape_string($_POST['ul_2']);
    $ul_3 = $conn->real_escape_string($_POST['ul_3']);
    $ul_4 = $conn->real_escape_string($_POST['ul_4']);
    $d_1 = $conn->real_escape_string($_POST['d_1']);
    $d_2 = $conn->real_escape_string($_POST['d_2']);
    $d_3 = $conn->real_escape_string($_POST['d_3']);
    $d_4 = $conn->real_escape_string($_POST['d_4']);
    $item_1 = $conn->real_escape_string($_POST['item_1']);
    $item_2 = $conn->real_escape_string($_POST['item_2']);
    $item_3 = $conn->real_escape_string($_POST['item_3']);
    $color = $conn->real_escape_string($_POST['color']);

    // Prepare the SQL statement with placeholders
    $stmt = $conn->prepare("UPDATE `footer` SET `map`=?,`address`=?,`email`=?,`number_1`=?,`number_2`=?,`about`=?,`logo`=?,`ul_1`=?,`ul_2`=?,`ul_3`=?,`ul_4`=?,`d_1`=?,`d_2`=?,`d_3`=?,`d_4`=?,`item_1`=?,`item_2`=?,`item_3`=?, `color`=? WHERE `id` = '1'");
    ...
    // Bind parameters
    $stmt->bind_param('sssssssssssssssssss', $map, $address, $email, $number_1, $number_2, $about, $fileName, $ul_1, $ul_2, $ul_3, $ul_4, $d_1, $d_2, $d_3, $d_4, $item_1, $item_2, $item_3, $color);

    // Execute the statement
    if ($stmt->execute()) {
        if ($map == $row['map'] || $address == $row['address'] || $email == $row['email'] || $number_1 == $row['number_1'] || $number_2 == $row['number_2'] || $about == $row['about'] || $fileName == $row['logo'] || $ul_1 == $row['ul_1'] || $ul_2 == $row['ul_2'] || $ul_3 == $row['ul_3'] || $d_1 == $row['d_1'] || $d_2 == $row['d_2'] || $d_3 == $row['d_3'] || $d_4 == $row['d_4'] || $item_1 == $row['item_1'] || $item_2 == $row['item_2'] || $item_3 == $row['item_3'] || $color == $row['color']) {
            echo "<script>
            ...
            echo "<script>
            alert('Footer update successfully');
            window.location.href = 'http://localhost/PHP%20project/admin/';
          </script>";
        }
    } else {
