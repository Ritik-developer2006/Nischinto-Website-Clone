        ...
        <div class="content-body">
            ...
            <div class="container-fluid">
                <div class="mb-sm-4 d-flex flex-wrap align-items-center text-head">
                    <h2 class="mb-3 me-auto">Edit Doctor Page</h2>
                </div>
                <div class="row">
                    <div class="col-12">
                        <div class="card" style="">
                            <div class="card-header">
                                <h2>Doctor Page Items</h2>
                            </div>
                            <div class="card-body">
                                <div class="form-validation">
                                    ...
                                    $sql = "SELECT * FROM doctor WHERE id = 1"; // Use single quotes for values
                                    ...
                                    <form class="needs-validation" novalidate method="post"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-6 col-md-3 mb-3">
                                                <label class="col-form-label" for="validationCustom02">Doctor image
                                                    :-</label>
                                                <div class="d-flex w-50 border p-2">
                                                    <img src="../uploads/<?php
                                                    echo $row['doctor1_img'];
                                                    ?>" alt="" class="w-100">
                                                </div>
                                            </div>
                                            <div class="col-6 col-md-3 mb-3">
                                                ...
                                                <div class="input-group">
                                                    <div class="form-file rounded-4 ps-2">
                                                        <input name="doctor1_img" type="file"
                                                            class="form-file-input py-3 rounded-4 form-control p-2">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-6 col-md-3 mb-3">
                                                <label class="col-form-label" for="validationCustom04">Doctor name<span
                                                        class="text-danger">*</span> :-
                                                </label>
                                                <input type="text" name="doctor1_name" class="form-control"
                                                    id="validationCustom04" placeholder="Enter Text here for button.."
                                                    value="<?php
                                                    echo $row['doctor1_name'];
                                                    ?>" required>
                                                <div class="invalid-feedback">
                                                    Please enter text.
                                                </div>
                                            ...
                                            <div class="col-6 col-md-3 mb-3">
                                                <label class="col-form-label" for="validationCustom04">Doctor
                                                    Speciality<span class="text-danger">*</span> :-
                                                </label>
                                                <input type="text" name="doctor1_specs" class="form-control"
                                                    id="validationCustom04" placeholder="Enter Text here for button.."
                                                    value="<?php
                                                    echo $row['doctor1_specs'];
                                                    ?>" required>
                                                <div class="invalid-feedback">
                                                    Please enter text.
                                                </div>
                                            ...
                                            <div class="col-6 col-md-3 mb-3">
                                                ...
                                                <div class="input-group">
                                                    <div class="form-file rounded-4 ps-2">
                                                        <input name="doctor2_img" type="file"
                                                            class="form-file-input py-3 rounded-4 form-control p-2">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-6 col-md-3 mb-3">
                                                ...
                                                <input type="text" name="doctor2_name" class="form-control"
                                                    id="validationCustom04" placeholder="Enter Text here for button.."
                                                    value="<?php
                                                    echo $row['doctor2_name'];
                                                    ?>" required>
                                                <div class="invalid-feedback">
                                                    Please enter text.
                                                </div>
                                            ...
                                            <div class="col-6 col-md-3 mb-3">
                                                ...
                                                <input type="text" name="doctor2_specs" class="form-control"
                                                    id="validationCustom04" placeholder="Enter Text here for button.."
                                                    value="<?php
                                                    echo $row['doctor2_specs'];
                                                    ?>" required>
                                                <div class="invalid-feedback">
                                                    Please enter text.
                                                </div>
                                            ...
                                            <div class="col-6 col-md-3 mb-3">
                                                ...
                                                <div class="input-group">
                                                    <div class="form-file rounded-4 ps-2">
                                                        <input name="doctor3_img" type="file"
                                                            class="form-file-input py-3 rounded-4 form-control p-2">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-6 col-md-3 mb-3">
                                                ...
                                                <input type="text" name="doctor3_name" class="form-control"
                                                    id="validationCustom04" placeholder="Enter Text here for button.."
                                                    value="<?php
                                                    echo $row['doctor3_name'];
                                                    ?>" required>
                                                <div class="invalid-feedback">
                                                    Please enter text.
                                                </div>
                                            ...
                                            <div class="col-6 col-md-3 mb-3">
                                                ...
                                                <input type="text" name="doctor3_specs" class="form-control"
                                                    id="validationCustom04" placeholder="Enter Text here for button.."
                                                    value="<?php
                                                    echo $row['doctor3_specs'];
                                                    ?>" required>
                                                <div class="invalid-feedback">
                                                    Please enter text.
                                                </div>
                                            ...
                                            <div class="col-6 col-md-3 mb-3">
                                                ...
                                                <div class="input-group">
                                                    <div class="form-file rounded-4 ps-2">
                                                        <input name="doctor4_img" type="file"
                                                            class="form-file-input py-3 rounded-4 form-control p-2">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-6 col-md-3 mb-3">
                                                ...
                                                <input type="text" name="doctor4_name" class="form-control"
                                                    id="validationCustom04" placeholder="Enter Text here for button.."
                                                    value="<?php
                                                    echo $row['doctor4_name'];
                                                    ?>" required>
                                                <div class="invalid-feedback">
                                                    Please enter text.
                                                </div>
                                            ...
                                            <div class="col-6 col-md-3 mb-3">
                                                ...
                                                <input type="text" name="doctor4_specs" class="form-control"
                                                    id="validationCustom04" placeholder="Enter Text here for button.."
                                                    value="<?php
                                                    echo $row['doctor4_specs'];
                                                    ?>" required>
                                                <div class="invalid-feedback">
                                                    Please enter text.
                                                </div>
...
if (isset($_POST['submit'])) {
    ...
    $fileName = $row['doctor1_img'];
    $fileName1 = $row['doctor2_img'];
    $fileName2 = $row['doctor3_img'];
    $fileName3 = $row['doctor4_img'];

    // Handle file uploads
    $fileName = handleFileUpload('doctor1_img', $fileName, $uploadDir);
    $fileName1 = handleFileUpload('doctor2_img', $fileName1, $uploadDir);
    $fileName2 = handleFileUpload('doctor3_img', $fileName2, $uploadDir);
    $fileName3 = handleFileUpload('doctor4_img', $fileName3, $uploadDir);

    // Sanitize and validate inputs
    $heading = $conn->real_escape_string($_POST['heading']);
    $sub_heading = $conn->real_escape_string($_POST['sub_heading']);
    $doctor1_name = $conn->real_escape_string($_POST['doctor1_name']);
    $doctor2_name = $conn->real_escape_string($_POST['doctor2_name']);
    $doctor3_name = $conn->real_escape_string($_POST['doctor3_name']);
    $doctor4_name = $conn->real_escape_string($_POST['doctor4_name']);
    $doctor1_specs = $conn->real_escape_string($_POST['doctor1_specs']);
    $doctor2_specs = $conn->real_escape_string($_POST['doctor2_specs']);
    $doctor3_specs = $conn->real_escape_string($_POST['doctor3_specs']);
    $doctor4_specs = $conn->real_escape_string($_POST['doctor4_specs']);

    // Prepare the SQL statement with placeholders
    $stmt = $conn->prepare("UPDATE `doctor` SET 
        `heading`=?, `sub_heading`=?, 
        `doctor1_img`=?, `doctor2_img`=?, `doctor3_img`=?, `doctor4_img`=?, 
        `doctor1_name`=?, `doctor2_name`=?, `doctor3_name`=?, `doctor4_name`=?, 
        `doctor1_specs`=?, `doctor2_specs`=?, `doctor3_specs`=?, `doctor4_specs`=?  
        WHERE `id` = '1'");
    ...
    // Execute the statement
    if ($stmt->execute()) {
        if ($heading == $row['heading'] || $sub_heading == $row['sub_heading'] || $fileName == $row['doctor1_img'] || $fileName1 == $row['doctor2_img'] || $fileName2 == $row['doctor3_img'] || $fileName3 == $row['doctor4_img'] || $doctor1_name == $row['doctor1_name'] || $doctor2_name == $row['doctor2_name'] || $doctor3_name == $row['doctor3_name'] || $doctor4_name == $row['doctor4_name'] || $doctor1_specs == $row['doctor1_specs'] || $doctor2_specs == $row['doctor2_specs'] || $doctor3_specs == $row['doctor3_specs'] || $doctor4_specs == $row['doctor4_specs']) {
            echo "<script>
