				...
				<ul class="metismenu" id="menu">
					...
					<li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
						...
						<ul aria-expanded="false">
							...
							<li><a href="message_form.php">Message form</a></li>
					...
					<li class="mm-active"><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="true">
						...
						<ul aria-expanded="true">
							...
							<li class="mm-active"><a href="Messages_list.php">Messages</a></li>
		...
		<div class="content-body">
			...
			<div class="container-fluid">
				<div class="mb-sm-4 d-flex flex-wrap align-items-center text-head">
					<h2 class="mb-3 me-auto">Messages</h2>
				</div>
				<div class="row">
					<div class="col-12">
						<div class="card">
							<div class="card-header">
								<h4 class="card-title">Total Messages are <?php
											include "../connect.php";
										...
										<tbody>
											...
											if ($total != 0) {
												while ($result = mysqli_fetch_assoc($data)) {
													echo "<tr>
															<td class='text-nowrap'>" . $result['id'] . "</td>
															<td class='text-nowrap'>" . $result['name'] . "</td>
															<td class='text-nowrap'>" . $result['email'] . "</td>
															<td class='text-nowrap'>" . $result['subject'] . "</td>
                                    							...
                                    							"<div class='modal fade' id='exampleModalCenter" . $result['id']+$result['id'] . "'>
                                        							<div class='modal-dialog modal-dialog-centered' role='document'>
                                        							    <div class='modal-content'>
                                        							        ...
                                        							        <div class='modal-body'>
																			<form class='row g-3 needs-validation' method='post' action='edit_message.php?id=".$result['id']."' novalidate>
																			<div class='col-md-6'>
																			...
																			<div class='col-md-6'>
																			  <label for='validationCustom03' class='form-label'>Contct No.</label>
																			...
																			<div class='col-md-6'>
																			  ...
																			  <input type='text' name='subject' class='form-control w-100 rounded-3' id='validationCustom01' value='".$result['subject']."' required>
																			  <div class='invalid-feedback'>
																			  	Please fill this!.
																			  </div>
																			</div>
																			<div class='col-md-12'>
																			  ...
																			  <textarea type='date' name='message' class='form-control w-100' id='validationCustom04' required>
																			  ".$result['message']."
																			  </textarea>
																			  <div class='invalid-feedback'>
																			  	Please fill this!.
												...
												echo "<tr>
														<td colspan='9' classs='text-center fs-4 text-warning fw-bold'>No Record is present!</td>
													</tr>";
											}
											?>
										</tbody>
