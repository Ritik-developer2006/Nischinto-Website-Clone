...
<body>
    ...
    <div class="card text-bg-dark rounded-0 border-0">
        ...
        <div class="card-img-overlay text-center content">
            <h1 class="card-title text-dark fw-bold text-size" style="text-shadow: 0px 0px 10px white;">Terms &
                Conditions</h1>
        </div>
    </div>
